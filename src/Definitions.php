...
class Definitions {
     ...
     */
    const RELATIONS = [
        'hasOne' => '{related} {--m|method=} {--p|plurals=} {--f|foreignKey=} {--l|localKey=}',
        'hasMany' => '{related} {--m|method=} {--p|plurals=} {--f|foreignKey=} {--l|localKey=}',
        'belongsTo' => '{related} {--m|method=} {--p|plurals=} {--f|foreignKey=} {--o|ownerKey=} {--n|nullable} {--i|index}',
        'belongsToMany' => '{related} {--p|plurals=} {--t|table=} {--f|foreignPivotKey=} {--r|relatedPivotKey=} {--k|parentKey=} {--l|relatedKey=}',
        'hasManyThrough' => '{related} {--p|plurals=} {through} {--f|firstKey=} {--s|secondKey=} {--l|localKey=} {--r|secondLocalKey=}',
        'morphTo' => '{--n|name=} {--t|type=} {--i|id=}',
        'morphOne' => '{related} {name} {--p|plurals=} {--t|type=} {--i|id=} {--l|localKey=}',
        'morphMany' => '{related} {name} {--p|plurals=} {--t|type=} {--i|id=} {--l|localKey=}',
        'morphToMany' => '{related} {name} {--p|plurals=} {--t|table=} {--f|foreignPivotKey=} {--r|relatedPivotKey=} {--k|parentKey=} {--l|relatedKey=} {--i|inverse}',
        'morphedByMany' => '{related} {name} {--p|plurals=} {--t|table=} {--f|foreignPivotKey=} {--r|relatedPivotKey=} {--k|parentKey=} {--l|relatedKey=}',
    ];
