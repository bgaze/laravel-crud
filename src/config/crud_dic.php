...
return [
    'migrate' => [
        ...
        'fields' => [
            'bigIncrements' => [
                'signature' => '{column} {--d|default=} {--n|nullable} {--i|index} {--iu|unique} {--c|comment=}',
                'template' => '$table->bigIncrements(\'%column\')',
                'description' => 'Add a bigIncrements field to table.',
            ],
            'bigInteger' => [
                'signature' => '{column} {--d|default=} {--n|nullable} {--a|autoIncrement} {--u|unsigned} {--i|index} {--iu|unique} {--c|comment=}',
            ...
            'char' => [
                'signature' => '{column} {length?} {--d|default=} {--n|nullable} {--i|index} {--iu|unique} {--c|comment=}',
            ...
            'decimal' => [
                'signature' => '{column} {total=8} {places=2} {--d|default=} {--n|nullable} {--u|unsigned} {--i|index} {--iu|unique} {--c|comment=}',
                'template' => '$table->decimal(\'%column\', %total, %places)',
                'description' => 'Add a decimal field to table.',
            ],
            'double' => [
                'signature' => '{column} {total=8} {places=2} {--d|default=} {--n|nullable} {--a|autoIncrement} {--u|unsigned} {--i|index} {--iu|unique} {--c|comment=}',
                'template' => '$table->double(\'%column\', %total, %places)',
                'description' => 'Add a double field to table.',
            ],
            'enum' => [
                'signature' => '{column} {allowed} {--d|default=} {--n|nullable} {--i|index} {--iu|unique} {--c|comment=}',
            ...
            'timestamp' => [
                'signature' => '{column} {--d|default=} {--u|useCurrent} {--n|nullable} {--i|index} {--iu|unique} {--c|comment=}',
            ...
            'unsignedBigInteger' => [
                'signature' => '{column} {--d|default=} {--n|nullable} {--a|autoIncrement} {--i|index} {--iu|unique} {--c|comment=}',
                'template' => '$table->unsignedBigInteger(\'%column\')',
                'description' => 'Add a unsignedBigInteger field to table.',
            ],
            'unsignedDecimal' => [
                'signature' => '{column} {total=8} {places=2} {--d|default=} {--n|nullable} {--a|autoIncrement} {--i|index} {--iu|unique} {--c|comment=}',
